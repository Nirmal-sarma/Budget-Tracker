                    ...
                    <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
                        ...
                        {!dataAvailable && (
                            <Card className='flex h-[300px] flex-col items-center justify-center bg-background'>
                                ...
                                <p className="">
                                    Please try a different period or adding new transactions.
                                </p>
                            </Card>
                        )}
                    </SkeletonWrapper>
...
function CustomToolTip(props: TooltipContentProps<number, string> & { formatter: Intl.NumberFormat }) {
    ...
    return (
        <div className="min-w-[300px] rounded bg-background p-4">
            ...
            <TooltipRow formatter={formatter} label="Balance" value={income-expense} bgColor="bg-gray-500" textColor="text-foreground-500" />
        </div>
    );
}
